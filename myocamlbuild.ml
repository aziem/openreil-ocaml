(* OASIS_START *)
(* DO NOT EDIT (digest: ca6383e285f938f0c05ed31b1ec40185) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("reil_bindings", ["bindings"], []); ("openreil", ["lib"], [])];
     lib_c = [("openreil", "lib", [])];
     flags =
       [
          (["oasis_library_openreil_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S [A "-cclib"; A "-lopenreil"; A "-cclib"; A "-lstdc++"])
            ]);
          (["oasis_library_openreil_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lopenreil"; A "-lstdc++"])]);
          (["oasis_library_openreil_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_openreil_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_openreil_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_openreil_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_openreil_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
