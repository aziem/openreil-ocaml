...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8588258aa846411a6273b27db1a3308c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Openreil"];
                      lib_pack = false;
                      lib_internal_modules = ["Ffi_generated_types"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "openreil";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "reil_bindings"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_openreil_static.ml"
                   });
               Executable
                 ({
                     cs_name = "test_openreil_dynamic";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lopenreil"; "-lstdc++"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_openreil_dynamic.ml"
                   })
            ];
     ...
     oasis_digest = Some "\185\144\143ku\165\134A\221\249~N\1275/\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
