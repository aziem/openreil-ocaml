...
(* OASIS_START *)
(* DO NOT EDIT (digest: 315e6de3c32852bff6a06943cd0dc396) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_openreil.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some ")\197<f\203\1364#qe\012'\026\202\148\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
